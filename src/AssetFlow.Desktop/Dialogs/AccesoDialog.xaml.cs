...
public partial class AccesoDialog : Window
{
    ...
    /// </summary>
    /// <remarks>
    /// No hay ninguna contraseña que escribir aquí: la genera el servidor
    /// al azar, la devuelve una sola vez para que se le pueda comunicar a
    /// su titular, y la persona queda obligada a cambiarla al entrar. Que
    /// el administrador no la elija es deliberado: una contraseña que
    /// conocen dos personas ya no identifica a ninguna.
    /// </remarks>
