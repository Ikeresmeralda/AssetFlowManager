...
public partial class UsuariosPage : UserControl
{
    ...
    private async void CambiarAcceso(UserDto usuario)
    {
        ...
        if (dlg.ReiniciarContrasena)
        {
            ...
            Aviso.Credencial(Window.GetWindow(this), "Contraseña provisional",
                $"Ésta es la contraseña de «{reinicio.Valor.Username}». " +
                "Cópiala o díctasela ahora: no se vuelve a mostrar.\n\n" +
                "Al entrar, la aplicación le pedirá que elija una contraseña " +
                "propia, y ésta dejará de funcionar. Caduca en 24 horas.\n\n" +
