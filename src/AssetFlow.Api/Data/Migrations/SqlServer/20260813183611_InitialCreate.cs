        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EstimatedReturnDate = table.Column<DateOnly>(type: "date", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LoanLines", x => x.Id);
                    table.ForeignKey(
                        name: "FK_LoanLines_Loans_LoanId",
                        column: x => x.LoanId,
                        principalTable: "Loans",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_LoanLines_Materials_MaterialId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LoanLines_LoanId_MaterialId",
                table: "LoanLines",
                columns: new[] { "LoanId", "MaterialId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_LoanLines_MaterialId",
                table: "LoanLines",
                column: "MaterialId");
